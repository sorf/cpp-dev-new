...
GCC_CXXFLAGS_DEBUG="$GCC_INCLUDE_PATHS -O0 -g -std=c++17 -Wall -Wextra"
GCC_CXXFLAGS_RELEASE="$GCC_INCLUDE_PATHS -O2  -std=c++17 -Wall  -Wextra"
GCC_LINKFLAGS_DEBUG="$GCC_LIB_PATHS $GCC_LIBS"
GCC_LINKFLAGS_RELEASE="$GCC_LIB_PATHS $GCC_LIBS"

CLANG_CXXFLAGS_DEBUG="$GCC_CXXFLAGS_DEBUG -Wglobal-constructors"
CLANG_CXXFLAGS_RELEASE="$GCC_CXXFLAGS_RELEASE -Wglobal-constructors"
